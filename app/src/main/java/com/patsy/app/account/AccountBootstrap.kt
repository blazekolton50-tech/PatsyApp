...
enum class BootstrapFailure { NOT_AUTHENTICATED, SESSION_EXPIRED, SESSION_MISMATCH, UNAUTHORIZED, FORBIDDEN, BACKEND_UNAVAILABLE, MALFORMED, INCONSISTENT, EXPIRED }
