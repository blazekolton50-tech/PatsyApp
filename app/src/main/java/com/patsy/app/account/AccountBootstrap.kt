...
enum class BootstrapFailure { NOT_AUTHENTICATED, SESSION_EXPIRED, SESSION_MISMATCH, BACKEND_UNAVAILABLE, MALFORMED, EXPIRED }

internal fun protectedBootstrap(userId: String): AccountBootstrap = AccountBootstrap(
